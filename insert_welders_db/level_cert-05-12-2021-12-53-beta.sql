...
--
-- Dumping data for table `level_cert`
--

LOCK TABLES `level_cert` WRITE;
/*!40000 ALTER TABLE `level_cert` DISABLE KEYS */;
INSERT INTO `level_cert` VALUES (4,'cupiditate'),(2,'et'),(1,'qui'),(3,'saepe');
/*!40000 ALTER TABLE `level_cert` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-05 12:53:41
