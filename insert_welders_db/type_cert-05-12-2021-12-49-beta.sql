...
--
-- Dumping data for table `type_cert`
--

LOCK TABLES `type_cert` WRITE;
/*!40000 ALTER TABLE `type_cert` DISABLE KEYS */;
INSERT INTO `type_cert` VALUES (2,'est'),(3,'inventore'),(1,'qui');
/*!40000 ALTER TABLE `type_cert` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-05 12:49:44
